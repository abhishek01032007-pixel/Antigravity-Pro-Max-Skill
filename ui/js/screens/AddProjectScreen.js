/**
 * AddProjectScreen.js - Add Local Project Screen (Stitch Reference)
 * Frozen directory flow without custom name fields, Git cloning, or auto-analyze toggles.
 */
    ...
    return `
      <div class="content-container" style="max-width: 680px;">
        ...
        <div class="card flex flex-col gap-6" style="padding: var(--space-6);">
          ...
          <div class="card" style="background-color: var(--color-surface-container); padding: var(--space-4); border-color: var(--color-outline-variant);">
            ...
            <div class="flex flex-col gap-2">
              <div class="flex items-center justify-between">
                ...
                <span style="font-size: var(--text-body-sm); font-weight: 600; color: var(--color-on-surface);">Academic Day Hub</span>
              </div>
              <div class="flex items-center justify-between">
                <span style="font-size: var(--text-meta); color: var(--color-outline);">Path:</span>
                <span class="code-pill">D:\\Projects\\academic_day_hub</span>
              </div>
              <div class="flex items-center justify-between">
                <span style="font-size: var(--text-meta); color: var(--color-outline);">Validation:</span>
                <div class="flex items-center gap-1 text-muted" style="font-size: var(--text-meta); color: var(--color-success);">
